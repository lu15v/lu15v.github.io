      ...
      <PageContentContainer>
        <div className="cont global-font">
          ...
          <main>
            ...
            In my free time, I enjoy: learning topics related to web development, playing the ukelele, watching series, reading novels and developing projects as a freelance.
